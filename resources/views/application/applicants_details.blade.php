...
<table class="w-full bg-white border border-gray-300 rounded-lg shadow-md">
    <thead class="bg-gray-100 text-gray-600 uppercase text-sm">
        <tr>
            <th class="px-6 py-3 border-b border-gray-200">User Name</th>
            <th class="px-6 py-3 border-b border-gray-200">CV</th>
        </tr>
    </thead>
    <tbody class="text-gray-700">
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 border-b border-gray-200">
                    <a href="{{ route('download', $jobapplication->cvname) }}" class="text-blue-500 hover:underline">Download CV Here</a>
                </td>
            </tr>
            @empty
